"""Curriculum learning: large -> small square shapes (PPO)."""
...
if __name__ == "__main__":
    ...
    log_dir = args.log_dir or f"./experiments/PPO_square_CL_large2small_seed{args.seed}"

    run_cl_experiment(
        strategy_name="CL_large2small",
